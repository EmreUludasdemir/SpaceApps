...
def cross_validate_pipeline(
    ...
    *,
    ...
    all_macro_specificity: List[float] = []
    ...
    for fold_index, (train_idx, test_idx) in enumerate(cv.split(X, y), start=1):
        ...
        all_macro_specificity.append(metrics["macro_specificity"])
        all_macro_f1.append(metrics["macro_f1"])
        all_macro_precision.append(metrics["macro_precision"])
        all_macro_recall.append(metrics["macro_recall"])
